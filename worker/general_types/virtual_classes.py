...
class Dictionarizable(object):
    ...
    def convert_geojsonpoint_todictionary(position: Point) -> Dict[str, Any]:
        ...
        return {LabelDatastreamGeneric.LABEL_DSGENERIC_COORDINATES: [position.x,
                                position.y],
                "type": "Point"}
    ...
    def convert_polygon_todictionary(polygon: Polygon) -> Dict[str, Any]:
        try:
            ...
            return {
                ...
                "geometry": {
                    LabelDatastreamGeneric.LABEL_DSGENERIC_COORDINATES:
                        [list_points],
                    "type": "Polygon"
                }
            }
...
class OutputMessage(Dictionarizable):
    ...
    def to_ogc_dictionary(self) -> Dict[str, Any]:
        return_dictionary = {
            ...
            LabelDatastreamGeneric.LABEL_DSGENERIC_RESULT: self.to_dictionary()
        }
...
class ObservableGeneric(object):
    ...
    def check_equals(self, observation):
        ...
        return self.check_is_observation(observation_id=observation.get_observation_id())
