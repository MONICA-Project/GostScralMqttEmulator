...
taskqueue_provisioning_exchange = Exchange('taskqueue_provisioning', type='direct')
...
CELERY_QUEUES = (
    ...
    Queue('taskqueue_provisioning',
          exchange=taskqueue_provisioning_exchange,
          routing_key='taskqueue_provisioning',
          consumer_arguments={'x-priority': 2}),
    Queue('queue_task_alive',
          exchange=task_alive_exchange,
...
MQTT_BROKERPROVISIONING = {
    ...
    MQTTLabelsConfigurations.LABEL_DICTIONARY_URL: 'mqtt',
