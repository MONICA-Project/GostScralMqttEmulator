...
class GeoPosition(object):
    ...
    def get_copy(self) -> "GeoPosition":
        geo_position = GeoPosition(latitude=self.latitude,
                                   longitude=self.longitude,
                                   altitude=self.altitude,
                                   request_ecef_conf=False)
        geo_position.ecef_x = self.ecef_x
        geo_position.ecef_y = self.ecef_y
        geo_position.ecef_z = self.ecef_z
        geo_position.type_position = self.type_position
    ...
    def add_enu_distance(self,
                         enu_distance: List[float]) -> "GeoPosition":
        try:
